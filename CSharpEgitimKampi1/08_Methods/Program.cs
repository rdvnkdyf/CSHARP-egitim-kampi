...
namespace _08_Methods
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //}
            //CustomerCard("Mehmet","Karahanlı");
            //CustomerCard("Süleyman", "Çakır");
            #endregion
            ...
            //string CountryCard(string countryName,string capita,string flagColor)
            //{
            ...
            //Console.WriteLine(Sum(12, 98));
            //Console.WriteLine(Sum(3,2));

            #endregion

            #region Örnek Uygulama
            // "+"Öğrenci sınavı geçti"+" Ortalama: "+result;
            //    }
            //    else
            //    {
